...
import { Target, Eye, ShieldCheck, Heart, Sparkles, Coffee } from 'lucide-react';
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                ...
                className="px-10 py-5 bg-white text-primary font-black rounded-2xl hover:scale-105 transition-transform shadow-xl"
              >
                Contáctanos Ahora
              </button>
              <button 
                onClick={() => navigate('/services')}
                className="px-10 py-5 bg-primary-dark text-white font-black rounded-2xl border-2 border-white/20 hover:bg-white/10 transition-colors"
              >
                Explorar Servicios
              </button>
            </div>
