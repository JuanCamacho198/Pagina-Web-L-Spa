  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 pt-24 pb-12">
      <div className="max-w-2xl w-full bg-white rounded-[3rem] shadow-2xl border border-gray-100 p-10 text-center animate-in fade-in zoom-in duration-700">
        ...
        <div className="bg-gray-50 rounded-3xl p-8 mb-10 text-left border border-gray-100 space-y-4">
          {totalAmount && (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link to="/citas" className="flex items-center justify-center gap-2 px-8 py-4 bg-white border-2 border-primary text-primary font-black rounded-2xl hover:bg-primary/5 transition-all">
            <Calendar size={20} /> Mis citas
          </Link>
          <Link to="/" className="flex items-center justify-center gap-2 px-8 py-4 bg-primary text-white font-black rounded-2xl hover:bg-primary-dark transition-all shadow-lg shadow-primary/20">
            <Home size={20} /> Inicio
          </Link>
        </div>
      </div>
