  ...
  if (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col items-center justify-center p-4">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl max-w-md w-full text-center border border-red-100 dark:border-red-900/30">
          <div className="w-20 h-20 bg-red-50 dark:bg-red-900/20 rounded-full flex items-center justify-center mx-auto mb-6">
            <Filter size={40} className="text-red-500" />
          </div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">¡Ups! Algo salió mal</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            No pudimos cargar los servicios en este momento. Por favor, intenta de nuevo más tarde.
          </p>
          <Button
          ...
          <button
            onClick={() => navigate('/')}
            className="mt-6 text-sm text-gray-500 hover:text-primary transition-colors font-medium"
          >
            Volver al Inicio
          </button>
        </div>
