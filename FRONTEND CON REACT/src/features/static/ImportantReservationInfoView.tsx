        ...
        <div className="bg-white rounded-[4rem] p-10 md:p-20 shadow-2xl shadow-gray-200/50 border border-gray-100 relative">
          ...
          <div className="relative z-10">
              ...
              {points.map((p, i) => (
                <div key={i} className="group relative">
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="w-px2 h-12 bg-gray-900 text-white rounded-4xll flex items-center justify-center transition-transform group-hover:scale-110 duration-300">
                      <p.icon size={22} />
                    </div>
            ...
            <div className="mt-20 p-8 bg-gray-50 rounded-[2.5rem] border border-dashed border-gray-300 flex flex-col md:flex-row items-center gap-6">
               <div className="w-px6 h-16 bg-white rounded-4xl flex items-center justify-center text-amber-600 shadow-sm shrink-0">
                  <Wine size={32} />
               </div>
