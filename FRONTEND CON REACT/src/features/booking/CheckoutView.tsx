      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 space-y-8">
            <Card className="p-8 border-none shadow-xl shadow-gray-200/50 rounded-4xl">
              <form onSubmit={handleSubmit(onCheckoutSubmit)} className="space-y-6">
                ...
                <div className={cn("space-y-6", currentStep !== 0 && "hidden")}>
                  <div className="flex items-center gap-4 mb-4">
                    <div className="p-3 bg-primary/10 rounded-4xl text-primary font-bold text-xl">01</div>
                    <div>
                  ...
                  <Button 
                    ...
                    className="w-full py-6 text-lg rounded-4xl shadow-lg mt-8"
                  >
                ...
                <div className={cn("space-y-6", currentStep !== 1 && "hidden")}>
                  <div className="flex items-center gap-4 mb-4">
                    <div className="p-3 bg-primary/10 rounded-4xl text-primary font-bold text-xl">02</div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-8 items-start">
                    <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="bg-primary/5 p-5 rounded-4xl border-2 border-primary/10 mt-6 shadow-sm">
                  ...
                  <Button 
                    type="button" 
                    onClick={validateStep}
                    className="w-full py-6 text-lg rounded-4xl shadow-lg mt-8 font-black uppercase tracking-widest bg-primary hover:bg-primary-dark transition-all"
                  >
                ...
                <div className={cn("space-y-6", currentStep !== 2 && "hidden")}>
                  <div className="flex items-center gap-4 mb-4">
                    <div className="p-3 bg-primary/10 rounded-4xl text-primary font-bold text-xl">03</div>
                    <div>
                  ...
                  <div className="flex flex-col gap-4 mt-8">
                    <Button 
                      ...
                      className="w-full py-8 text-xl rounded-4xl shadow-2xl shadow-primary/30"
                    >
                      {isSubmitting ? (
                        <>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <Card className="p-8 bg-linear-to-br from-gray-900 to-gray-800 text-white rounded-4xl border-none shadow-2xl">
              ...
              <div className="p-4 bg-white/5 rounded-4xl flex items-center gap-3 text-sm opacity-60">
                <ShieldCheck size={18} />
