    ...
    <>
      ...
      {notification && (
        <div className="fixed top-24 right-4 z-50 animate-in slide-in-from-right duration-300">
          <div className={`flex items-center gap-3 px-6 py-4 rounded-4xl shadow-2xl border ${
          ...
          <div className="lg:col-span-2 space-y-8">
             ...
             <div className="bg-white p-10 md:p-12 rounded-[3rem] shadow-xl border border-gray-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                   <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-4xl">
                      <Clock className="text-primary" size={24} />
                      <div className="text-sm font-bold text-gray-700">{service.duration} min</div>
                   </div>
                   <div className="flex items-center gap-3 p-4 bg-primary/5 rounded-4xl">
                      <Tag className="text-primary" size={24} />
                      <div className="text-sm font-bold text-gray-700">{service.category}</div>
                   </div>
                   {service.intensity && (
                     <div className="flex items-center gap-3 p-4 bg-yellow-50 rounded-4xl">
             ...
             <div className="sticky top-28 bg-white p-8 rounded-[2.5rem] shadow-2xl border border-primary/10 space-y-6">
                ...
                <div className="space-y-4 pt-4">
                   <button 
                    ...
                    className="w-full py-5 bg-primary text-white font-black rounded-4xl hover:bg-primary-dark transition-all transform hover:-translate-y-1 shadow-lg shadow-primary/20 flex items-center justify-center gap-3"
                   >
                     <Calendar size={22} />
                     Reservar Ahora
                   </button>
