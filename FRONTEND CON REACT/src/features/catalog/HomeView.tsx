      ...
      <main className="grow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <Card key={i} className="flex flex-col items-center text-center group hover:-translate-y-2 transition-transform duration-300 p-8 border-none shadow-xl shadow-gray-200/50 dark:shadow-black/50 bg-white dark:bg-gray-800">
                  <div className="mb-6 p-4 bg-primary/5 rounded-4xl group-hover:bg-primary/10 transition-colors">
        ...
        <section className="py-20 bg-white dark:bg-gray-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative group overflow-hidden rounded-4xl shadow-2xl border-none">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {services.slice(0, 3).map((service) => (
                  <Card key={service.id} className="overflow-hidden group border-none shadow-lg hover:shadow-2xl transition-all duration-300 rounded-4xl">
                    ...
                    <div className="p-8">
                      ...
                      <Button 
                        variant="secondary" 
                        className="w-full rounded-4xl group-hover:bg-primary group-hover:text-white transition-colors"
                        onClick={() => navigate(`/services`)}
                      >
                        Reservar Ahora
                      </Button>
